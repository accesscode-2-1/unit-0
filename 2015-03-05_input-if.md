...
Your calculator only needs to handle 3 inputs: 2 `int`s and 1 operator. You may test an RPN calculator [http://www.abecedarical.com/javascript/script_reverse_polish.html](here).
