...
## JSON Parsing
- json-simple is a good json parsing library : [ json-simple ] (https://code.google.com/p/json-simple/)
- You'll need to download the jar file and add this external library into your class path

### Adding jar files into your classpath
Go to Project-> Libraries and add the directory folder that has the JARs. Everything in that folder will be added to CLASSPATH.
![ adding jar files into your classpath ](https://github.com/accesscode-2-1/unit-0/blob/master/images/classpath.png?raw=true)
