...
##### Calling a method
Methods have names and are used by writing their name followed by parentheses. When we use a method, we say we *call* or *invoke* it. Here is an example:
...
##### Getting a result
Methods can *return* a value. This means that method call itself has a value and can be stored like any other value or variable:
